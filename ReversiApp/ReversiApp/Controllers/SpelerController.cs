...
using ReversiApp.Models.Account;
...
namespace ReversiApp.Controllers
{
    ...
    public class SpelerController : Controller
    {
            ...
            ILoggerFactory loggerFactory)
        {
            ...
            _logger = loggerFactory.CreateLogger<SpelerController>();
        }
        ...
        public async Task<IActionResult> Login(Login model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = await _signInManager.PasswordSignInAsync(model.Identity, model.Password, model.RememberMe, lockoutOnFailure: false);
                if (result.Succeeded)
                {
                ...
                {
                    result = await ((EmailSignInManager)_signInManager).EmailPasswordSignInAsync(model.Identity, model.Password, model.RememberMe, lockoutOnFailure: false);
                    if (result.Succeeded)
                    {
                        _logger.LogInformation(1, "User logged in.");
                        return RedirectToLocal(returnUrl);
        ...
        public async Task<IActionResult> Register(Register model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                if (!ReCaptchaPassed(
                    ...
                    _logger))
                {
                    ModelState.AddModelError(string.Empty, "Please verify you're not a robot.");
                    return View(model);
                }
                var user = new Speler { Naam = model.Username, Wachtwoord = model.Password, UserName = model.Username, Email = model.Email, Token = Guid.NewGuid().ToString() };
                var result = await _userManager.CreateAsync(user, model.Password);
                if (result.Succeeded)
                {
                    _userManager.AddToRoleAsync(user, "Speler").Wait();
        ...
        public async Task<IActionResult> ResetPassword(ResetPassword model)
        {
            ...
            if (user == null)
            {
                ...
                return RedirectToAction(nameof(SpelerController.ResetPasswordConfirmation), "Account");
            }
        ...
        public async Task<ActionResult> SendCode(string returnUrl = null, bool rememberMe = false)
        {
            ...
            return View(new SendCode { Providers = factorOptions, ReturnUrl = returnUrl, RememberMe = rememberMe });
        }
        ...
        public async Task<IActionResult> VerifyCode(string provider, bool rememberMe, string returnUrl = null)
        {
            ...
            return View(new VerifyCode { Provider = provider, ReturnUrl = returnUrl, RememberMe = rememberMe });
        }
        ...
        public async Task<IActionResult> VerifyAuthenticatorCode(bool rememberMe, string returnUrl = null)
        {
            ...
            return View(new VerifyAuthenticatorCode { ReturnUrl = returnUrl, RememberMe = rememberMe });
        }
        ...
        public async Task<IActionResult> UseRecoveryCode(string returnUrl = null)
        {
            ...
            return View(new UseRecoveryCode { ReturnUrl = returnUrl });
        }
