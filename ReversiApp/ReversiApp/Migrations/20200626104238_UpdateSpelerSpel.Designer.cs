...
namespace ReversiApp.Migrations
{
    ...
    [Migration("20200626104238_UpdateSpelerSpel")]
    partial class UpdateSpelerSpel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReversiApp.Models.SpelerSpel", b =>
                {
                    ...
                    b.HasKey("SpelerId", "SpelID");

                    b.HasIndex("SpelID");

                    b.ToTable("SpelerSpel");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ReversiApp.Models.Speler", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ReversiApp.Models.Speler", b =>
                {
                    b.HasOne("ReversiApp.Models.Spel", null)
                        .WithMany("Spelers")
            ...
            modelBuilder.Entity("ReversiApp.Models.SpelerSpel", b =>
                {
                    ...
                    b.HasOne("ReversiApp.Models.Speler", "Speler")
                        .WithMany("SpelerSpel")
