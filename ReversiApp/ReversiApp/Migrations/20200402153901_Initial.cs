    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Spel", x => x.SpelID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Wachtwoord = table.Column<string>(maxLength: 50, nullable: false),
                    Token = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SpelerId = table.Column<string>(nullable: false),
                    SpelID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpelerSpel", x => new { x.SpelerId, x.SpelID });
                    table.ForeignKey(
                        name: "FK_SpelerSpel_Spel_SpelID",
                        column: x => x.SpelID,
                        principalTable: "Spel",
                        principalColumn: "SpelID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SpelerSpel_AspNetUsers_SpelerId",
                        column: x => x.SpelerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
